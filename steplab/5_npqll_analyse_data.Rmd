...
cat("Upon careful inspection of the learning outcome assessment data, two participants were identified who provided non-responses in at least 14 out of 15 free-text items. Data from these two participants were excluded from the analyses. As such, the sample analysed here consisted of N = ", sum(!is.na(all$score_posttest)), "participants.\n\n")
